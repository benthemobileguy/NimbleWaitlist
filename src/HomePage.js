    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <header className="bg-[#005051] text-white py-2 px-6 z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden sm:flex space-x-6">
            <Link to="/" className="text-white text-sm sm:text-base font-extrabold">
              Home
            </Link>
            <Link to="/about" className="text-white text-sm sm:text-base font-extrabold">
              About Us
            </Link>
            <Link to="/contact" className="text-white text-sm sm:text-base font-extrabold">
              Contact Us
            </Link>
          </nav>
        </div>
      ...
      <footer className="bg-[#005051] text-white py-4 text-center z-10">
        <p className="mb-2 text-sm sm:text-base">
          Contact us:{" "}
          <a
            href="mailto:sales@getnimbleapp.com"
